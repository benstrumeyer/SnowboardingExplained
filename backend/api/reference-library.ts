...
import {
  createReferenceSignalSet,
  getReferenceSignalSet,
  getReferenceSignalSetsForPhase,
  getBestReferenceSignalSet,
  getReferenceSignalSetsForTrick,
  getReferenceSignalSetsByCoach,
  listAllReferenceSignalSets,
  updateReferenceSignalSet,
  deleteReferenceSignalSet,
  getReferenceLibraryStats,
  searchReferenceSignalSetsByTags,
  getReferenceSignalSetsWithMinQuality,
} from '../src/services/referenceLibraryService';
 ...
 * }
 */
router.post('/reference-library/create', async (req: Request, res: Response) => {
  try {
    const {
      trick,
      phase,
    ...
    const referenceSet = await createReferenceSignalSet(
      trick,
      phase,
      stance,
      sourceVideoId,
 ...
 */
router.get('/reference-library/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/reference-library/trick/:trick/phase/:phase', async (req: Request, res: Response) => {
  try {
    const { trick, phase } = req.params;
    const { stance } = req.query;

    const referenceSets = await getReferenceSignalSetsForPhase(
      trick,
      phase as any,
      stance as 'regular' | 'goofy' | undefined
    );
 ...
 */
router.get('/reference-library/best/:trick/:phase/:stance', async (req: Request, res: Response) => {
  try {
    ...
    const referenceSet = await getBestReferenceSignalSet(trick, phase as any, stance as 'regular' | 'goofy');
 ...
 */
router.get('/reference-library/trick/:trick', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/reference-library/coach/:coachName', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/reference-library/list', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/reference-library/stats', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/reference-library/search/tags', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/reference-library/quality/:minQuality', async (req: Request, res: Response) => {
  try {
 ...
 */
router.put('/reference-library/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.delete('/reference-library/:id', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
