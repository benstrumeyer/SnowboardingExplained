 ...
 */
router.get('/smoothing/status', (req, res) => {
    try {
 ...
 */
router.post('/smoothing/enable', (req, res) => {
    try {
 ...
 */
router.post('/smoothing/disable', (req, res) => {
    try {
 ...
 */
router.post('/smoothing/reset', (req, res) => {
    try {
 ...
 */
router.post('/smoothing/parameters', (req, res) => {
    try {
...
//# sourceMappingURL=smoothing-control.js.map