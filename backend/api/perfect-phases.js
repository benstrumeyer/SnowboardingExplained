...
router.post('/save', async (req, res) => {
    try {
        const { trickName, phaseName, stance, frames, dataQuality, } = req.body;
...
router.get('/', async (req, res) => {
    try {
        ...
        const filters = {};
        if (trickName)
            filters.trickName = trickName;
        if (phaseName)
            filters.phaseName = phaseName;
        if (stance)
 ...
 */
router.get('/frames/:frameId/analysis', async (req, res) => {
    try {
 ...
 */
router.get('/frames/:frameId/phase-indicator', async (req, res) => {
    try {
        const { frameId } = req.params;
...
//# sourceMappingURL=perfect-phases.js.map