 ...
 * Uses Tailwind (twrnc) for all styling
 */
    ...
    <View style={tw`flex-1 bg-gray-900`}>
      ...
      >
        <View style={tw`flex-1 flex-row`}>
          {/* Sidebar */}
          <View style={tw`w-3/4 bg-gray-800 pt-12 px-4`}>
            {/* Close Button */}
            <TouchableOpacity
            ...
            <ScrollView style={tw`flex-1`}>
              ...
              <TouchableOpacity
                style={tw`flex-row items-center py-3 px-4 rounded-lg mb-2 ${
                  inputMode === 'text' && currentScreen === 'chat' ? 'bg-blue-900/50' : ''
                }`}
              ...
              <TouchableOpacity
                style={tw`flex-row items-center py-3 px-4 rounded-lg mb-4 ${
                  inputMode === 'voice' && currentScreen === 'chat' ? 'bg-blue-900/50' : ''
                }`}
