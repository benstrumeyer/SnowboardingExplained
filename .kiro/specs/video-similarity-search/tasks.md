...
- [ ] 1. Implement Synonym Expander
  - [ ] 1.1 Create synonym mapping dictionary with snowboarding abbreviations (bs, fs, sw, 3, 5, 7, etc.)
    - Define mappings for directions, rotations, tricks, and grabs
    - _Requirements: 1.1, 1.2_
  - [ ] 1.2 Implement expand() function that processes query strings
...
- [ ] 2. Implement TF-IDF Scorer
  - [ ] 2.1 Create TF-IDF initialization function
    ...
    - _Requirements: 3.1_
  - [ ] 2.2 Implement score() function for query-title matching
...
- [ ] 3. Implement Fuzzy Search with Fuse.js
  - [ ] 3.1 Install and configure Fuse.js with optimized settings
    ...
    - _Requirements: 2.3_
  - [ ] 3.2 Implement fuzzy search wrapper function
...
- [ ] 4. Implement Score Combiner
  - [ ] 4.1 Create combine() function with weighted scoring
...
- [ ] 5. Integrate Video Search Service
  - [ ] 5.1 Refactor video-search.ts to use new search components
    - Initialize TF-IDF weights on module load
    - Wire up synonym → fuzzy → TF-IDF → combiner pipeline
    - _Requirements: 5.1, 5.2_
  - [ ] 5.2 Update chat API to fill video slots with similarity search
...
- [ ] 7. Implement Question Flow Manager
  - [ ] 7.1 Create question configuration data structure
  ...
  - [ ] 7.2 Implement QuestionFlowManager class
...
- [ ] 8. Implement Follow-up Mode
  - [ ] 8.1 Add follow-up detection in chat API
    - Detect when initial coaching is complete
    - Maintain original UserContext for follow-ups
    - _Requirements: 12.1, 12.3_
  - [ ] 8.2 Implement reduced video response for follow-ups
...
- [ ] 10. Implement Sidebar Component
  - [ ] 10.1 Create Sidebar component with slide-out animation
...
- [ ] 11. Implement Voice Input
  - [ ] 11.1 Set up voice input library
